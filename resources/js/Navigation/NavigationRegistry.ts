  ...
  },
  {
    ...
    items: [
      ...
      child('nav-modules', 'Modules & Add-ons', '/modules', Cpu, { permission: 'modules.manage', category: 'System' }),
      {
        ...
        category: 'System',
        children: [
          child('nav-settings', 'General Settings', '/settings', Settings, { permission: 'modules.manage', category: 'System' }),
          child('nav-languages', 'Languages', '/languages', Languages, { permission: 'modules.manage', category: 'Localization' }),
          child('nav-email-templates', 'Email Templates', '/settings/email-templates', Mail, { permission: 'modules.manage', category: 'Communication' }),
          child('nav-notification-templates', 'Notification Templates', '/notification-templates', Bell, { permission: 'modules.manage', category: 'Communication' }),
          child('nav-notifications', 'Notifications', '/notifications', Bell, { permission: 'workspace.view', category: 'Communication' }),
          child('nav-webhooks', 'Webhooks', '/webhooks', Webhook, { permission: 'modules.manage', category: 'Integration' }),
          child('nav-api-tokens', 'API Tokens', '/settings/api-tokens', KeyRound, { permission: 'modules.manage', category: 'Integration' }),
        ],
      },
    ],
  },
