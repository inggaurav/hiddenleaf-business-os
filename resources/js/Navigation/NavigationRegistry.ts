    ...
    items: [
      {
        ...
        module: 'sales',
        category: 'Sales',
        description: 'Sales performance, conversion metrics, and revenue velocity',
      },
      {
    ...
    items: [
      {
        ...
        description: 'Purchasing volumes, vendor bills, and payable obligations',
      },
      {
        ...
        category: 'Inventory',
        description: 'Stock valuation, warehouse levels, and stock movements',
      },
      {
    ...
    items: [
      {
        ...
        module: 'account',
        category: 'Finance',
        description: 'Cash flow, customer receipts, vendor payments, and balances',
      },
      {
      ...
      },
      {
        ...
        module: 'account',
        category: 'Finance',
        description: 'Double-entry journal transactions and balance posting',
      },
      {
        id: 'nav-accounting-reports',
        ...
        module: 'account',
        category: 'Finance',
        description: 'Trial balance, profit & loss statement, and balance sheet',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        module: 'hrm',
        category: 'HRM',
        description: 'Workforce overview, attendance, leaves, and payroll',
      },
      {
        id: 'nav-hrm-employees',
        ...
        module: 'hrm',
        category: 'HRM',
        description: 'Employee directory, branches, departments, and designations',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        module: 'lead',
        category: 'CRM',
        description: 'Sales pipeline value, conversion rates, and deal velocity',
      },
      {
        id: 'nav-crm-leads',
        name: 'Leads & Deals',
        ...
        module: 'lead',
        category: 'CRM',
        description: 'Lead qualification, deal stages, notes, and activity history',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        module: 'taskly',
        category: 'Projects',
        description: 'Project milestones, task velocity, completion rates, and timesheets',
      },
      {
        id: 'nav-taskly-projects',
        name: 'Projects & Tasks',
        ...
        module: 'taskly',
        category: 'Projects',
        description: 'Sprint boards, task assignment, milestones, and timesheets',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        module: 'pos',
        category: 'POS',
        description: 'Daily counter revenue, top products, payment breakdown, and register stats',
      },
      {
        id: 'nav-pos-terminal',
        name: 'POS Terminal',
        ...
        module: 'pos',
        category: 'POS',
        description: 'Fast barcode checkout, active register session, and receipt generation',
      },
    ],
  },
  {
