                    ...
                    <tr key={c.id} className="hover:bg-white/[0.02] spring-transition">
                      <td className="px-5 py-3.5 font-medium text-[var(--text-primary)]">
                        <div className="flex items-center gap-2.5">
                          <div className="w-7 h-7 rounded-lg bg-[var(--surface-2)] border border-[var(--border-subtle)] flex items-center justify-center text-[var(--text-secondary)] font-bold text-xs">
                            {c.name.charAt(0)}
                          </div>
                          <div>
                            <div>{c.name}</div>
                            {c.tax_number && <div className="text-xs text-[var(--text-tertiary)]">Tax: {c.tax_number}</div>}
                          </div>
                        </div>
                      </td>
