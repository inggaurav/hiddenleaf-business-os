...
$pluginDir = $baseDir . DIRECTORY_SEPARATOR . 'notice-board-plugin';
$zipPath = $baseDir . DIRECTORY_SEPARATOR . 'notice-board.zip';
$manifestPath = $pluginDir . DIRECTORY_SEPARATOR . 'module.json';

if (!is_dir($pluginDir)) {
    fwrite(STDERR, "notice-board-plugin directory not found!\n");
    exit(1);
}
