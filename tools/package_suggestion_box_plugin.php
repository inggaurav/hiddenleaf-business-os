...
$pluginDir = $baseDir . DIRECTORY_SEPARATOR . 'suggestion-box-plugin';
$zipPath = $baseDir . DIRECTORY_SEPARATOR . 'suggestion-box.zip';
$manifestPath = $pluginDir . DIRECTORY_SEPARATOR . 'module.json';

if (!is_dir($pluginDir)) {
    fwrite(STDERR, "suggestion-box-plugin directory not found!\n");
    exit(1);
}
