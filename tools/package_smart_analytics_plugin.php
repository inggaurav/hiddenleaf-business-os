...
/**
 * Package smart-analytics-plugin into a signed zip.
 */

require __DIR__ . '/../vendor/autoload.php';

$alias = 'smart-analytics';
$pluginDir = __DIR__ . '/../smart-analytics-plugin';
...
$tempDir = sys_get_temp_dir() . '/smart-analytics-verify-' . time();
...
if (file_exists($extractedModule)) {
    ...
    if (isset($manifest['checksum'])) {
        ...
        // Note: checksum in manifest would match a self-referential hash
    }
} else {
