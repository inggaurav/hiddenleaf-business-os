...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['module' => 'settings', 'resource' => 'company', 'action' => 'manage', 'name' => 'settings.company.manage'],
            ['module' => 'settings', 'resource' => 'brand', 'action' => 'manage', 'name' => 'settings.brand.manage'],
            ['module' => 'settings', 'resource' => 'localization', 'action' => 'manage', 'name' => 'settings.localization.manage'],
            ['module' => 'settings', 'resource' => 'billing', 'action' => 'manage', 'name' => 'settings.billing.manage'],
            ['module' => 'settings', 'resource' => 'integrations', 'action' => 'manage', 'name' => 'settings.integrations.manage'],
            ['module' => 'settings', 'resource' => 'notifications', 'action' => 'manage', 'name' => 'settings.notifications.manage'],
            ['module' => 'settings', 'resource' => 'modules', 'action' => 'manage', 'name' => 'settings.modules.manage'],
